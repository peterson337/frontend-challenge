...
type Course = {
  ...
  settings: {
    ...
    end_at: string;
    start_at: string;
    course_types: { live: boolean; online: boolean; presential: boolean };
...
export default function Courses({ coursesData }: { coursesData: Course[] }) {
  ...
  return (
    <>
      ...
      <div className="mt-5 grid md:grid-cols-[repeat(auto-fit,22rem)] justify-center">
