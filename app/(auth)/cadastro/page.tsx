...
export default function CadastroPage() {
  ...
  return (
    <div className="relative z-0 flex flex-col md:flex-row w-full min-h-screen bg-white">
      {/* Container - Mobile*/}
      <div className="relative z-0 flex flex-col items-center w-full md:w-1/2 2xl:w-full md:justify-center md:min-h-screen px-4 pt-[34px] pb-[48px] md:px-8 min-h-screen md:bg-white">
        {/* Form Container */}
        <div className="hidden md:flex md:flex-row md:absolute md:top-8 md:left-8 md:gap-2">
          <Brand />
        </div>
